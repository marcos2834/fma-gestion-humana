  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:560px; margin:0 auto; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 24px rgba(0,0,0,0.08);">
    ...
    <tr>
      <td style="padding:40px 32px;">
        ...
        <p style="font-size:13px; color:#999; line-height:1.5; margin:28px 0 0; text-align:center;">📎 Tu informe también está adjunto como PDF en este mail · podés guardarlo y leerlo offline cuando quieras</p>
      </td>
    </tr>
    <tr>
